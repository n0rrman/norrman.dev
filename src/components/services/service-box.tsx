    ...
    <div className="flex -mt-8 h-full">
      <div className="flex flex-row items-start justify-center h-full ml-[-1rem] md:ml-0 px-0 md:px-2 lg:px-6 ">
        <div className="flex flex-row items-center justify-start mt-8 mini:mt-7">
          ...
          <div
            className={`${numberFont.className} px-2 text-5xl mini:text-6xl`}
          >
            {number}
          </div>
        </div>
        <div className="hidden mini:flex text-3xl sm:text-4xl mr-[-1.1rem] sm:mr-[-1.25rem] mt-[2.7rem] sm:mt-10 justify-center items-center">
        ...
        <div className="relative flex flex-row pt-10 border-l-4 border-slate-400/50 pl-3 sm:pl-4 h-full w-full">
          <div className="hidden mini:block border-t-4 mt-4 border-blueTo w-6 sm:w-16 md:w-28" />

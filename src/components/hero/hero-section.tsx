...
export default function HeroSection({
  ...
  return (
    <section id="hero" className="flex flex-col items-center h-[65vh] w-full">
      <div className="flex flex-col-reverse md:flex-row h-full md:h-[calc(85vh-8rem)] w-full items-center justify-center gap-2 xl:gap-32 transition-all container">
        <div className="flex flex-col items-center md:items-start w-[20rem] mini:w-[23rem] sm:w-[30rem] pl-0 md:pl-10 flex-0 gap-6 lg:gap-8 text-center md:text-left">
          <h1 className="text-4xl lg:text-5xl font-semibold">
            {heading}
            <span className="text-fuchsia-700">!</span>
          </h1>
          <p className="text-normal lg:text-lg">{subheading}</p>
          <Link
        ...
        <div className="relative flex justify-center items-center aspect-[1.6] w-[20rem] mini:w-[23rem] sm:w-[29rem] md:w-[30rem] lg:w-[32.5rem]">
          <Image
